...
type OrderClient interface {
	...
	OrderDetail(ctx context.Context, in *OrderDetailRequest, opts ...grpc.CallOption) (*OrderInfoResponse, error)
}
...
func (c *orderClient) OrderDetail(ctx context.Context, in *OrderDetailRequest, opts ...grpc.CallOption) (*OrderInfoResponse, error) {
	out := new(OrderInfoResponse)
...
type OrderServer interface {
	...
	OrderDetail(context.Context, *OrderDetailRequest) (*OrderInfoResponse, error)
...
func (UnimplementedOrderServer) OrderDetail(context.Context, *OrderDetailRequest) (*OrderInfoResponse, error) {
