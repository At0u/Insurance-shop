...
type GoodsClient interface {
	...
	//根据分类查询
	GetGoodsByCategory(ctx context.Context, in *GoodInfoRequest, opts ...grpc.CallOption) (*GoodsListResponse, error)
	...
	//分类相关
	GetAllCategoryList(ctx context.Context, in *CategoryListRequest, opts ...grpc.CallOption) (*CategoryListResponse, error)
...
func (c *goodsClient) GetGoodsByCategory(ctx context.Context, in *GoodInfoRequest, opts ...grpc.CallOption) (*GoodsListResponse, error) {
	out := new(GoodsListResponse)
	err := c.cc.Invoke(ctx, "/Goods/GetGoodsByCategory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goodsClient) GetAllCategoryList(ctx context.Context, in *CategoryListRequest, opts ...grpc.CallOption) (*CategoryListResponse, error) {
...
type GoodsServer interface {
	...
	//根据分类查询
	GetGoodsByCategory(context.Context, *GoodInfoRequest) (*GoodsListResponse, error)
	...
	//分类相关
	GetAllCategoryList(context.Context, *CategoryListRequest) (*CategoryListResponse, error)
...
func (UnimplementedGoodsServer) GetGoodsByCategory(context.Context, *GoodInfoRequest) (*GoodsListResponse, error) {
...
func (UnimplementedGoodsServer) GetAllCategoryList(context.Context, *CategoryListRequest) (*CategoryListResponse, error) {
...
func _Goods_GetGoodsByCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Goods/GetGoodsByCategory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).GetGoodsByCategory(ctx, req.(*GoodInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Goods_GetAllCategoryList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).GetAllCategoryList(ctx, req.(*CategoryListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
