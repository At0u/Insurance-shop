...
type HumanInfo struct{
	...
	IdentityNum string `gorm:"index:idx_identity,unique;varchar(50);not null"`
}

type GoodsSellCount struct{
	BaseModel
	ProductId int32 `gorm:"index:idx_productId;type:int;not null" json:"id"`
	SellNum  int32 `gorm:"type:int;default:0"`
}

type CategorySellCount struct{
	BaseModel
	CategoryId int32 `gorm:"index:idx_categoryId;type:int;not null" json:"id"`
	SellNum  int32 `gorm:"type:int;default:0"`
}
