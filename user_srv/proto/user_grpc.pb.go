...
type UserClient interface {
	...
	ChangeUserRole(ctx context.Context, in *ChangeUserRoleInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
	CheckPassWord(ctx context.Context, in *PasswordCheckInfo, opts ...grpc.CallOption) (*CheckResponse, error)
	ChangePassWord(ctx context.Context, in *ChangePassInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *userClient) ChangeUserRole(ctx context.Context, in *ChangeUserRoleInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/User/ChangeUserRole", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) ChangePassWord(ctx context.Context, in *ChangePassInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type UserServer interface {
	...
	ChangeUserRole(context.Context, *ChangeUserRoleInfo) (*emptypb.Empty, error)
	CheckPassWord(context.Context, *PasswordCheckInfo) (*CheckResponse, error)
	ChangePassWord(context.Context, *ChangePassInfo) (*emptypb.Empty, error)
...
func (UnimplementedUserServer) ChangeUserRole(context.Context, *ChangeUserRoleInfo) (*emptypb.Empty, error) {
...
func (UnimplementedUserServer) ChangePassWord(context.Context, *ChangePassInfo) (*emptypb.Empty, error) {
...
func _User_ChangeUserRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/User/ChangeUserRole",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).ChangeUserRole(ctx, req.(*ChangeUserRoleInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_ChangePassWord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).ChangePassWord(ctx, req.(*ChangePassInfo))
	}
	return interceptor(ctx, in, info, handler)
}
